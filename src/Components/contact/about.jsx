...
export default function AboutPage() {
    ...
    return (<><div className="d-flex justify-content-center row pb-5 pt-5" id="About">
        ...
        <div className="d-flex justify-content-between w-85"> 
            ...
            <span className="mt-2"><i className="fas fa-envelope-open-text"></i></span>
        </div>
            ...
            <ul style={{listStyle:"none",}}>
                <li className="mb-3">My Linkedin: <a href="https://www.linkedin.com/in/Mariog108/" target="blank" className="btn btn-outline-primary" > <i className="fab fa-linkedin-in"></i> Mario's Github  </a></li>
                <li className="mb-3">My Github profile: <a href="https://github.com/MarioG108" target="blank" className="btn btn-outline-info" > <i className="fab fa-github"></i> Mario's Github  </a></li>
                <li className="mb-3">Proyect Repository: <a href="https://github.com/MarioG108/MovieApp" target="blank" className="btn btn-outline-info" > <i className="fab fa-github"></i> Github Repository </a></li>
            </ul>
